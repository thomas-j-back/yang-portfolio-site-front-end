...
export const CasePreview: FunctionComponent<CasePreviewProps> = ({
    ...
    return (
        <motion.div className="flex flex-col-reverse even:sm:flex-row odd:sm:flex-row-reverse justify-between sm:gap-x-5 gap-x-1 mb-28">
            <motion.div initial="initial" whileInView="animate" amount={0.8} viewport={{ once: true, amount: 0.5 }} variants={caseVariants.left} className="max-w-sm flex flex-col justify-between">
